...
# 2. Print the shape, number of rows-columns, data types, feature names, and description
...
# 4. Add 5 rows with duplicate values and missing values, and add a 'remarks' column
data_to_add = {
